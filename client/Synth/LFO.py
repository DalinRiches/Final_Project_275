...
class lfo:
    ...
    def __init__(self, synth, samplerate=44100, device=None, control=None,
                 amount=0.1,offset=-0.5, wavetype='sin', speed=1):
    ...
    def update_control(self, device=None, control=None):
        '''
            This function updates the desired control based on a float
            from -1 to 1 generated by genOutput.

                Args:
                    device=None,    Object of the device to control, valid
                                    options are filter from filt.py, wtOsc from
                                    osc.py, envelope from envelope.py and lfo
                                    from LFO.py

                    control=None,   str, string containing the control you
                                    want to modulate. The types are documented
                                    in the synth.py docstring as well as there
                                    respective string
